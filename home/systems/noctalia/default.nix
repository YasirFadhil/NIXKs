...

{
    ...
    settings = {
      ...
      bar = {
        ...
        wallpaper = {
          ...
          directory                  = "/etc/nixos/home/themes/wallpapers";
          monitorDirectories         = [ ];
  ...
  # User systemd service: start noctalia-shell as a user unit instead of spawning it via niri
